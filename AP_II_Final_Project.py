...
def honda():
    ...
    if arac_model == "city":
        ...
        y_fiyat = kurlu_fiyat + (kurlu_fiyat * (18 / 100))  # Güncel fiyatı
        lansman_fiyat = kurlu_fiyat + (kurlu_fiyat * (10 / 100))  # lansman fiyatı
...
gelen_arac = int(input("Bugün gelen araç sayısı:(Geçmek için 'q' tuşuna basın.) "))
if gelen_arac == "q":
    break
    ...
    for i in range(len(gelen_arac)):
        arac_marka = input(i+1, ". araç markasını giriniz: ")
        arac_marka.lower()
